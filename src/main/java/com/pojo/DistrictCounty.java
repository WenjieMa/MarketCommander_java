...
/**
 * DistrictCounty entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "district_county", catalog = "marketcommander")
public class DistrictCounty implements java.io.Serializable {
	...
	/** default constructor */
	public DistrictCounty() {
	}

	/** full constructor */
	public DistrictCounty(Short id, String name, Short parentId, String code, Short order) {
		this.id = id;
		this.name = name;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DistrictCounty))
			return false;
		DistrictCounty castOther = (DistrictCounty) other;
