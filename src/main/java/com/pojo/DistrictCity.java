...
/**
 * DistrictCity entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "district_city", catalog = "marketcommander")
public class DistrictCity implements java.io.Serializable {
	...
	/** full constructor */
	public DistrictCity(Short id, String name, Short parentId, String code, Short order) {
		this.id = id;
		this.name = name;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DistrictCity))
			return false;
		DistrictCity castOther = (DistrictCity) other;
